...
@Component({
    selector: 'options-input-multilang',
    templateUrl: './options-input-multilang.component.html',
    styleUrls: ['./options-input-multilang.component.scss'],
})
export class OptionsInputMultilangComponent implements OnChanges {
