...
@Component({
    selector: 'options-markdown-multilang',
    templateUrl: './options-markdown-multilang.component.html',
    styleUrls: ['./options-markdown-multilang.component.scss'],
})
export class OptionsMarkdownMultilangComponent implements OnChanges {
